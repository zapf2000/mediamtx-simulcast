...
func (co *PeerConnection) Start() error {
	...
	// DTLS passive for OBS Linux compatibility (pion/dtls v3.1.4)
	if co.Publish {
		// DTLS passive for OBS Linux (libdatachannel) compatibility
		settingsEngine.SetAnsweringDTLSRole(webrtc.DTLSRoleServer)
	}
